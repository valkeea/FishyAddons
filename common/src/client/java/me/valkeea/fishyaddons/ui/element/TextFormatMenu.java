...
public class TextFormatMenu {
    ...
    private void renderGradientPreview(DrawContext context, int x, int y, int width, int height, String gradientName) {
        ...
        RenderUtils.border(context, x, y, width, height, 0xFF666666);
    }
        ...
        if (totalEntries > visibleEntries) {
            ...
            if (mouseX >= scrollbarX && mouseX <= scrollbarX + scrollbarWidth && 
                ...
                if (mouseY >= thumbY && mouseY <= thumbY + thumbHeight) {
                    ...
                    double trackClickY = mouseY - startY - scrollKnobOffset;
    ...
    public boolean mouseDragged(Click click) {
        ...
        if (isDraggingScrollbar) {
            ...
            if (totalEntries > visibleEntries) {
                ...
                double thumbTopY = click.y() - startY - scrollKnobOffset;
