...
public class Beacon {
    ...
    public static void renderBeacon(WorldRenderContext context, IBeaconData beacon) {
        ...
        var camPos = client.gameRenderer.getCamera().getCameraPos();
        ...
        VertexConsumer fillConsumer = context.consumers().getBuffer(RenderLayers.debugQuads());
    ...
    private static void renderCylinder(WorldRenderContext context, MatrixStack matrices, int color, float outerSize) {
        ...
        var consumer = context.consumers().getBuffer(RenderLayers.debugQuads());
