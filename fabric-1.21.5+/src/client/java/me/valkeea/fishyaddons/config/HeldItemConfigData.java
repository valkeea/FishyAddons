...
public class HeldItemConfigData {
     ...
     * Copy constructor
     */
    public HeldItemConfigData(HeldItemConfigData other) {
     ...
     */
    public static HeldItemConfigData fromJson(String json) {
        if (json == null || json.trim().isEmpty()) {
            return new HeldItemConfigData();
        }
        
        try {
            return GSON.fromJson(json, HeldItemConfigData.class);
        } catch (Exception e) {
            return new HeldItemConfigData();
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        HeldItemConfigData that = (HeldItemConfigData) obj;
