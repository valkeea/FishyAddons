...
public class WaypointCmd {
    ...
    public static int addNext() {
        ...
        if (targetChain != null) {
            ...
            return addUserWaypoint(lastModified, nextOrder, currentArea, mc.player.getBlockPos());
        }
    ...
    public static int addWaypoint(String chainName, int orderNumber) {
        ...
        return addUserWaypoint(chainName, orderNumber, currentArea, mc.player.getBlockPos());
    }
