...
public class GUIChatAlert extends Screen {
    ...
    public GUIChatAlert(Screen parent) {
    ...
    calcDimensions(FishyConfig.getFloat(Key.MOD_UI_SCALE, 0.4265625f));
        for (Map.Entry<String, AlertData> entry : FishyConfig.getChatAlerts().entrySet()) {
            ...
            entries.add(e);
            this.addDrawableChild(e.keyField);
            this.addDrawableChild(e.editBtn);
            this.addDrawableChild(e.delBtn);
            this.addDrawableChild(e.toggleBtn);
        }
    ...
    private class AddEntry {
        ...
        public AddEntry() {
            this.keyField = new VCTextField(GUIChatAlert.this.textRenderer, 0, 0, fieldW, fieldH, Text.literal("Key"));
            this.keyField.setDrawsBackground(false);
            this.keyField.setText("");
            this.keyField.setEditable(true);
            this.keyField.setMaxLength(50);
            ...
            GUIChatAlert.this.setFocused(this.keyField);
        ...
        public void abortEntry() {
            ...
            GUIChatAlert.this.remove(this.saveBtn);
            GUIChatAlert.this.remove(this.cancelBtn);
            GUIChatAlert.this.init();
        }
    ...
    private class Entry {
        ...
        public Entry(String key) {
            this.keyField = new VCLabelField(GUIChatAlert.this.textRenderer, 0, 0, fieldW, fieldH, Text.literal("Key"));
            ...
            this.editBtn = VCButton.createNavigationButton(
                ...
                btn -> {
                    ...
                    MinecraftClient.getInstance().setScreen(new AlertEditScreen(currentKey, data, GUIChatAlert.this));
                },
                uiScale - 0.1f
            );
            ...
            this.delBtn = VCButton.createNavigationButton(
                ...
                btn -> {
                    ...
                    GUIChatAlert.this.remove(this.delBtn);
                    GUIChatAlert.this.remove(this.toggleBtn);
                    GUIChatAlert.this.init();
                }, uiScale
            );
