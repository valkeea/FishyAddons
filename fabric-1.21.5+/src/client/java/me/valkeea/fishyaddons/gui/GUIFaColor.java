...
public class GUIFaColor extends Screen {
    ...
    public GUIFaColor(Screen parent) {
    ...
    private class AddEntry {
        ...
        private int color = 0xFFB8E4;
        private ButtonWidget colorBtn;
        private ButtonWidget saveBtn;
        private ButtonWidget cancelBtn;

        public AddEntry() {
            this.nameField = new VCTextField(GUIFaColor.this.textRenderer, 0, 0, FIELD_WIDTH, FIELD_HEIGHT, Text.literal("Name"));
            this.nameField.setText("");
            this.nameField.setEditable(true);
            this.nameField.setMaxLength(32);
            this.nameField.setUIScale(UI_SCALE);
            this.nameField.setFocused(true);
            GUIFaColor.this.setFocused(this.nameField);   
                ...
                btn -> {
                    ...
                    MinecraftClient.getInstance().setScreen(new ColorWheel(GUIFaColor.this, rgb, selected -> {
                        ...
                        if (!name.isEmpty()) {
                            ...
                            addMode = false;
                            GUIFaColor.this.remove(this.nameField);
                            GUIFaColor.this.remove(this.colorBtn);
                            GUIFaColor.this.remove(this.saveBtn);
                            GUIFaColor.this.remove(this.cancelBtn);
                            GUIFaColor.this.init();
                        } else {
            ...
            this.saveBtn = new FaButton(
                ...
                btn -> {
                    String name = this.nameField.getText().trim();
                    if (!name.isEmpty()) {
                        FaColors.saveUserEntry(name, color & 0xFFFFFF);
                        addMode = false;
                        GUIFaColor.this.remove(this.nameField);
                        GUIFaColor.this.remove(this.colorBtn);
                        GUIFaColor.this.remove(this.saveBtn);
    ...
    private class Entry {
        ...
        public Entry(String name, int color) {
            ...
            this.delBtn = new FaButton(
                ...
                btn -> {
                    ...
                    GUIFaColor.this.remove(this.nameField);
                    GUIFaColor.this.remove(this.colorBtn);
                    GUIFaColor.this.remove(this.delBtn);
                    GUIFaColor.this.init();
                }
            );
        }
        ...
        public void saveIfChanged() {
            ...
            if (!newName.isEmpty() && (changed || !newName.equals(originalName) || color != originalColor)) {
                ...
                FaColors.saveUserEntry(newName, color & 0xFFFFFF);
