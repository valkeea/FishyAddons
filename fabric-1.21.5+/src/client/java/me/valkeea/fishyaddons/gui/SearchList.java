...
public class SearchList {
    ...
    public static final List<SearchEntry> FEATURES = List.of(
        ...
        new SearchEntry("Profit tracker", "General tracker (save data from HUD).\nUse /fa profit to see commands.", () -> sb()),        
        ...
        new SearchEntry("Damage Particle Scale", "Change the size of damage\n(crit) particles.\nColor is taken from redstone color", () -> sb()),
