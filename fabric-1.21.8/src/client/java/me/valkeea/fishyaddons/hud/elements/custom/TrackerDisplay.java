...
public class TrackerDisplay implements HudElement {
    ...
    private List<ItemValueData> lastDisplayedItems = new ArrayList<>();
    ...
    private Set<String> getExcludedItems() {
        ...
        return new HashSet<>(java.util.Arrays.asList(excludedStr.split(",")));
    }
    ...
    @Override public int getHudColor() { return FishyConfig.getHudColor(HUD_KEY, 0xFF8AE2B6); }
