...
public class WorldElements {
    ...
    protected static void text(LevelRenderContext ctx, 
     PoseStack matrices, String text, double x, double y, double z, int color) {
        ...
        var rotation = mc.gameRenderer.mainCamera().rotation();
    ...
    protected static void boxOutline(Matrix4f matrix, AABB box, VertexConsumer consumer, float r, float g, float b, float a) {
        float[] color = {r, g, b, a};
    ...
    protected static void boxFill(Matrix4f matrix, AABB box, VertexConsumer consumer, float r, float g, float b, float a) {
        float[] color = {r, g, b, a};
